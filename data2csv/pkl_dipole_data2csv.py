...
Qx_ArrSelected=one_dipole_component_extract_ForOneT(startingfileIndTmp,lagTmp,component_Qx,sweep_to_writeTmp)
Qy_ArrSelected=one_dipole_component_extract_ForOneT(startingfileIndTmp,lagTmp,component_Qy,sweep_to_writeTmp)
...
save_oneComponent_dipole_data(Qx_ArrSelected,TStr,component_Qx,init_path)
save_oneComponent_dipole_data(Qy_ArrSelected,TStr,component_Qy,init_path)
