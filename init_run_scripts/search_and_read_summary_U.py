...
#this script initializes the parameters for mc computation by reading U summary file
...
summaryFileName_U=TDirRoot+"/summary_U.txt"
summaryFileExists= os.path.isfile(summaryFileName_U)
...
#parse summary file
with open(summaryFileName_U,"r") as fptr:
